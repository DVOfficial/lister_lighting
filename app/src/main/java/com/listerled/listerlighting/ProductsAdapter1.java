...
//        mListener=listener;
//    }
    public ProductsAdapter1(Context mCtx, List<DataModel1> productList, RecyclerViewItemOnClickListener recyclerViewItemOnClickListener) {
        this.mCtx = mCtx;
...
//            stock=itemView.findViewById(R.id.stock);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    recyclerViewItemOnClickListener.onItemClick(getAdapterPosition());
                }
            });
