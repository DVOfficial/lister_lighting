...
//
    ...
    RecyclerView rv_HotSellingProducts, rv_UpcomingProducts, rv_Offers, rv_AllProducts;
//            rv_OutdoorProducts, rv_IndoorProducts, rv_SMPSDrivers,;
    private ProductsAdapter adaptor_HotSellingProducts, adaptor_UpcomingProducts, adaptor_Offers,adaptor_AllProducts;
//    private ProductsSubCatAdapter adaptor_OutdoorProducts, adaptor_IndoorProducts, adaptor_SMPSDrivers;
    List<DataModel1> list_hotSellingProducts, list_UpcomingProducts, list_Offers, list_AllProducts;
//        list_OutdoorProducts, list_IndoorProducts, list_SMPSDrivers,;
...
//    private final String URLNew = "https://script.google.com/macros/s/AKfycbyqK43fBc8lCt4smuLrFhjVEUR9ArYT9vyaRZvm2V6ChmZ7FuBuNNWLrybO0IOFpSY8/exec";
    private final String URLNew = "https://script.google.com/macros/s/AKfycbwmIluM6NWscmZkVtkzicrmz5ZTvIK99ela2ZDS2Welf79w8D0X8VYr822yUyJRje99Eg/exec";
//    private final String URL_Subcat = "https://script.google.com/macros/s/AKfycbyo2cnGTttv69en0LS1kaacieGZobOma-COpnuAeSPlM9yw-s8XGMtnHEmh5T8TluHdnA/exec";
    private final String URL_Subcat = "https://script.google.com/macros/s/AKfycbyckf1UCa_CgiiNCYmeeg1gQixRnRcQRdaYXdkttIsdjaVw5Qg2Z-Btxh3wLkE2qtyV/exec";
...
//        fusedLocationProviderClient= LocationServices.getFusedLocationProviderClient(this);
        ...
        rv_FetchProduct.setLayoutManager(new LinearLayoutManager(AllProducts.this));
...
//        dialogEng = new ProgressDialog(AllProducts.this);
...
//        rv_SMPSDrivers = findViewById(R.id.rv_SMPSDrivers);
        ...
        GridLayoutManager glm_AllProducts = new GridLayoutManager(this, 2);
//        LinearLayoutManager llm_Indoor = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        rv_AllProducts.setLayoutManager(glm_AllProducts);
        list_AllProducts = new ArrayList<>();
        adaptor_AllProducts = new ProductsAdapter(getApplicationContext(), list_AllProducts);
        rv_AllProducts.setAdapter(adaptor_AllProducts);
...
//                        return true;
    ...
    public void search1(String newText) {
        rv_FetchProduct.setVisibility(View.VISIBLE);
...
//    }
    ...
    private void fetchHotSellingProducts() {
        dialogEng = new ProgressDialog(AllProducts.this);
        dialogEng.setTitle("Wait Please... ");
        dialogEng.setMessage("Loading products");
        dialogEng.show();
...
//                            recyclerView.setAdapter(productsAdapter);
                            ...
                            e.printStackTrace();
                            Toast.makeText(AllProducts.this, "Error" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            dialogEng.dismiss();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AllProducts.this, "Error" + error.getMessage(), Toast.LENGTH_SHORT).show();
...
//                                if (upcoming.equals("yes")) {
                                    list_AllProducts.add(new DataModel1(sno, productcode, category, subcategory, series, model, url, hotselling, upcoming, offer));
...
//        ActivityCompat.requestPermissions(AllProducts.this, new String[]
...
//
//                response -> Toast.makeText(AllProducts.this, "DeviceID Submitted Successfully1", Toast.LENGTH_SHORT).show(),
//                error -> Toast.makeText(AllProducts.this, "DeviceID Error", Toast.LENGTH_SHORT).show()
//        ) {
//            @Override
...
//
//        RequestQueue queue = Volley.newRequestQueue(AllProducts.this);
...
//                            if (location !=null){
//                                Geocoder geocoder=new Geocoder(AllProducts.this, Locale.getDefault());
...
//                                                public void onComplete(@NonNull Task<Void> task) {
//
//                                                    Toast.makeText(AllProducts.this, "Location submitted successfully", Toast.LENGTH_SHORT).show();
//
//
//                                                }
//                                            }).addOnFailureListener(new OnFailureListener() {
...
//                                                @Override
//                                                public void onResponse(String response) {
//                                                    Toast.makeText(AllProducts.this, "Location Submitted Successfully1", Toast.LENGTH_SHORT).show();
//
//                                                }
//                                            },
//                                            new Response.ErrorListener() {
//                                                @Override
//                                                public void onErrorResponse(VolleyError error) {
//                                                    Toast.makeText(AllProducts.this, "Location Error", Toast.LENGTH_SHORT).show();
//
//                                                }
//                                            }
//                                    ) {
