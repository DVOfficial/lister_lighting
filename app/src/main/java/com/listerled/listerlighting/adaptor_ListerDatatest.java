...
public class adaptor_ListerDatatest extends RecyclerView.Adapter<adaptor_ListerDatatest.MyViewHolder> {
...
//        void onWebLinkClick(int position);
    ...
    public adaptor_ListerDatatest(Context context, List<Class_ListerData> mDatalistNew) {
