...
public class PlaceOrder1 extends AppCompatActivity {
    ...
    private TextView tv_ProductId, tv_ProductWatt, tv_Color, tv_ProductType,tv_address, tv_partyName, tv_city,tv_toast;             //declaring TextView to show the errors
    ...
    Button btn_AddtoCart, button_GotoCart;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        button_GotoCart = findViewById(R.id.button_GotoCart);    //Finds a view that was identified by the android:id attribute in xml
//        btn_Login = findViewById(R.id.btn_Login);    //Finds a view that was identified by the android:id attribute in xml
        ...
        tv_toast = findViewById(R.id.tv_toast);    //Finds a view that was identified by the android:id attribute in xml
        ...
        stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (parentID == R.id.spinner_indian_states){
                    switch (productID){
                        case "Select Product": districtAdapter = ArrayAdapter.createFromResource(parent.getContext(),
...
//            Toast.makeText(PlaceOrder1.this,color,Toast.LENGTH_SHORT).show();
        ...
        btn_AddtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String quantity1= et_Quantity.getText().toString().trim();
                if (!quantity1.equals("")){
...
//                String  productId=tv_ProductId.getText().toString().trim();
//                String  productWatt=tv_ProductWatt.getText().toString().trim();
...
//if
                ...
                if (productID.equals("Select Product") && (productWatt.equals("Select Watt") && quantity==0)){
                    Toast.makeText(PlaceOrder1.this, "Please fill the details", Toast.LENGTH_SHORT).show();
                }else{


                AppDatabase db= Room.databaseBuilder(getApplicationContext(),AppDatabase.class,"cart_db").allowMainThreadQueries().build();
                ProductDao productDao=db.ProductDao();
                Boolean check=productDao.is_exist(productID+"_"+productWatt);

                if(!check)
                {
                    productDao.insertrecord(new CartModel(partyname,city,address,productID,productWatt,productID+"_"+productWatt,pdtType,color,quantity,remarks));
//                    t1.setText("");
//                    t2.setText("");
//                    t3.setText("");
//                    t4.setText("");
                    tv_toast.setText("Product Inserted Successfully");
                }
                else
                {

                    tv_toast.setText("Product Already in Cart");
                }
                }
            }
        });
        ...
        button_GotoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PlaceOrder1.this,CartData.class));
...
//                Toast.makeText(PlaceOrder1.this, "Please select your Product from the list", Toast.LENGTH_LONG).show();
...
//                Toast.makeText(PlaceOrder1.this, "Please select your Watt from the list", Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(PlaceOrder1.this, "Please select Color", Toast.LENGTH_LONG).show();
...
//                Toast.makeText(PlaceOrder1.this, "Please select Product Type", Toast.LENGTH_LONG).show();
...
//                                Toast.makeText(PlaceOrder1.this, "Order Submitted Successfully", Toast.LENGTH_SHORT).show();
//
//                            }
//                        },
...
//                                Toast.makeText(PlaceOrder1.this, "Order Error"+error.getMessage(), Toast.LENGTH_SHORT).show();
//
//                            }
//                        }
//                ) {
...
//
//                RequestQueue queue = Volley.newRequestQueue(PlaceOrder1.this);
...
//        btn_Login1 = findViewById(R.id.btn_Login1);    //Finds a view that was identified by the android:id attribute in xml
////
        SessionManagement sessionManagement = new SessionManagement(PlaceOrder1.this);
...
//            current_stock="Login";
            ...
            button_GotoCart.setVisibility(View.GONE);
            btn_Login1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(PlaceOrder1.this, Login1Activity.class);
...
//                            recyclerView.setAdapter(productsAdapter);
                            ...
                            e.printStackTrace();
//                            dialogEng.dismiss();
//                            Toast.makeText(PlaceOrder1.this, "Error" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
//                        Toast.makeText(PlaceOrder1.this, "Error" + error.getMessage(), Toast.LENGTH_SHORT).show();
//                        dialogEng.dismiss();
